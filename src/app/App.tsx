      ...
      >
        ...
        <div className="md:hidden">
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent
              side="right"
              className="w-full bg-[#0a0a0a] border-l-[#1a1a1a] p-0 flex flex-col [&>button:first-child]:hidden"
            >
              <div className="flex flex-col h-full pt-20 px-8 pb-12">
                ...
                <div className="mb-12">
                  <img
                    src={LogoImg}
                    alt="MrFone"
                    className="w-20 h-20 object-contain invert brightness-125"
                  />
                </div>
                ...
                <div className="mt-auto flex flex-col gap-8">
                  ...
                  >
                    <p className="text-[10px] uppercase tracking-[0.2em] text-[#52525b] font-semibold mb-4">
                      Connect
                    </p>
                    <a
                      href={WA_LINK}
                    ...
                    >
                      <span className="w-8 h-8 rounded-full bg-[#111] border border-[#1a1a1a] flex items-center justify-center">
                  ...
                  >
                    <p className="text-[10px] uppercase tracking-[0.2em] text-[#52525b] font-semibold mb-2">
                      Store Location
                    </p>
                    <p className="text-white/60 text-sm leading-relaxed">
                      Ground Floor, OK Tower<br />
